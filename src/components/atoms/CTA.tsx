...
const CTA = memo(({ blok }: CTAProps) => {
  ...
  // Base styles
  const baseStyles = 'box-border flex gap-4 items-center justify-center font-semibold rounded-xl tracking-wide transition-all duration-200 hover:opacity-90';
  ...
  const typeStyles = {
    ...
    'link': 'bg-transparent text-primary-700 px-0 py-0 underline hover:no-underline',
  };
