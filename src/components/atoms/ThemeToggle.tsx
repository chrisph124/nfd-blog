...
const ThemeToggle = memo(() => {
  ...
  if (!mounted) {
    return <div className="size-7 md:size-8 xl:size-10 rounded-full bg-gray-200" aria-hidden="true" />;
  }
  ...
  return (
    <button
      ...
      onClick={toggle}
      className={`flex size-7 md:size-8 xl:size-10 shrink-0 cursor-pointer items-center justify-center rounded-full border transition-all duration-300 ${
        isDark
