...
/**
 * alert blok — a reusable accent box (announcement / alert / post TL;DR). The
 * accent color drives border + icon + title via currentColor; the richtext body
 * stays text-foreground for readable contrast. Server component: a short TL;DR
 * needs no client interactivity, so it renders the richtext inline.
 */
  ...
  return (
    <AlertRoot color={color} {...makeStoryblokEditable(blok)}>
      ...
      <div className="flex flex-col gap-1">
        ...
        {html && (
          <AlertDescription
            className="richtext text-foreground"
